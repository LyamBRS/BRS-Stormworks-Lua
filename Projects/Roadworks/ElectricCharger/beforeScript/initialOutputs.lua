...
-- [BRS] - Controls the charging station's cable anchor relay.
-- `true` will connect it to the station's grid.
...
-- `true` will connect it to the station's grid, allowing charging of vehicles, if `g_relayCable = true`
-- `false` will disconnect it from the station's grid.
g_relayCharger = true

-- [BRS] - Controls the charging station's discharger's relay.
-- `true` will connect it to the station's grid, allowing discharging of vehicles, if `g_relayCable = true`
-- `false` will disconnect it from the station's grid.
